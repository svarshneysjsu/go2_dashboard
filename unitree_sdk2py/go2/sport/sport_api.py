...
# works only in ai mode
SPORT_API_ID_AUTO_SWITCH_MOVE_MODE = 1038
SPORT_API_ID_STANDOUT = 1039
SPORT_API_ID_SET_AUTO_ROLL_RECOVERY = 1040
SPORT_API_ID_GET_AUTO_ROLL_RECOVERY = 1041
